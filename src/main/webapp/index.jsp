...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=http://localhost:9090/testAliPay/alipay.trade.page.pay.jsp method=post
			target="_blank">
		...
		<form name=tradequery action=http://localhost:9090/testAliPay/alipay.trade.query.jsp method=post
			target="_blank">
		...
		<form name=traderefund action=http://localhost:9090/testAliPay/alipay.trade.refund.jsp method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=http://localhost:9090/testAliPay/alipay.trade.fastpay.refund.query.jsp method=post
			target="_blank">
		...
		<form name=tradeclose action=http://localhost:9090/testAliPay/alipay.trade.close.jsp method=post
			target="_blank">
