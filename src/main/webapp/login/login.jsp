                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/admin/login" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/getImageCode"  onclick="getImageCode(this)">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="enCode" id="form-code" minlength="4" required>
                            </div>
